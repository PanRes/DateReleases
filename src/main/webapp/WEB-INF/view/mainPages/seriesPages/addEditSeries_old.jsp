...
<html>
	...
	<body>
		...
		<form:form action="${pageContext.request.contextPath}/series/saveOrUpdateSeries" enctype="multipart/form-data"
			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-lg-9 form-group">
						<form:input type="text" path="channel.name" class="form-control" />
					</div>
				</div>
<%--
...
--%>
				...
				<div class="row text-center">
					<input type="submit" class="btn btn-success btn-lg" name="submitBtn" value="Save Changes">
				</div>
			</div>
		</form:form>
